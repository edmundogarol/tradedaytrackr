      ...
      <Section style={{ width: "95%" }}>
        <SectionText>
          <div className="contact-page">
            ...
            <p>
              Have questions, feedback, or need help with your account? We're
              here to help.
            </p>
            ...
            <p>
              TradeDayTrackR is actively being developed, and we welcome
              feedback from traders. If you have ideas for new features or
